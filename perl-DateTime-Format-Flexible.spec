...
Source0  : https://cpan.metacpan.org/authors/id/T/TH/THINC/DateTime-Format-Flexible-0.34.tar.gz
...
%prep
%setup -q -n DateTime-Format-Flexible-0.34
cd %{_builddir}/DateTime-Format-Flexible-0.34
...
cp %{_builddir}/DateTime-Format-Flexible-0.34/LICENSE %{buildroot}/usr/share/package-licenses/perl-DateTime-Format-Flexible/6b487264931a742fc55971d43c27b8decdf4c8bb
if test -f Makefile.PL; then
